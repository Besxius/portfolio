...
export const translations = {
  ...
  vi: {
    ...
    sections: {
      ...
      experienceTitle: "Dự Án",
      experienceDesc: "Các dự án nổi bật và kinh nghiệm chi tiết của tôi",
    ...
    admin: {
      ...
      passwordPrompt: "Nhập mật khẩu Admin",
      submit: "Mở Khóa",
      loginError: "Sai mật khẩu.",
      save: "Lưu Thay Đổi",
      addNewProject: "Thêm Dự Án",
      editProfile: "Sửa Hồ Sơ",
      addWork: "Thêm Nơi Làm Việc",
      addExperience: "Thêm Dự Án",
      hide: "Ẩn",
      unhide: "Hiện",
      delete: "Xóa",
